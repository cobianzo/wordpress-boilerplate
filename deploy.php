 ...
 * @var string
 	...
 	SETUP HERE:
 */
if (!defined('SECRET_ACCESS_TOKEN')) define('SECRET_ACCESS_TOKEN', '0d7e53faed00b4d8abd86f2f8d9e19d7b734954c');
 ...
 * @var string
  	SETUP HERE:
 */
if (!defined('REMOTE_REPOSITORY')) define('REMOTE_REPOSITORY', 'https://github.com/cobianzo/wordpress-boilerplate.git');
 ...
 * @var string
  	SETUP HERE:
 */
if (!defined('BRANCH')) define('BRANCH', 'conrad');
 ...
 * @var string Full path including the trailing slash
  	SETUP HERE:
 */
if (!defined('TARGET_DIR')) define('TARGET_DIR', '/home/cobianzo/conrad/');
